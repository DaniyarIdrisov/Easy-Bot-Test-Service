package ru.daniyar.idrisov.testservice.security.providers.impl;
...
public class JwtProviderImpl implements JwtProvider {
    ...
    public String generateAccessToken(AccountEntity accountEntity) {
        ...
        return Jwts.builder()
                .setSubject(accountEntity.getEmail())
                .setExpiration(accessExpiration)
                .signWith(jwtAccessSecret)
                .claim("roles", accountEntity.getRoles())
                .claim("name", accountEntity.getFirstName() + " " + accountEntity.getLastName())
                .compact();
    }
